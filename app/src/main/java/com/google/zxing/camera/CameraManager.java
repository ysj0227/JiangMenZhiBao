...
public final class CameraManager {
	...
	public static final int FRAMING_Y_CENTER = -1;
	...
	private int framingY = FRAMING_Y_CENTER;
	...
	public int getFramingY() {
		return framingY;
	}
	public void setFramingY(int framingY) {
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			int topOffset = this.framingY;
			if (this.framingY == FRAMING_Y_CENTER) {
				topOffset = (screenResolution.y - height) / 2;
			}
			framingRect = new Rect(leftOffset, topOffset + this.offsetY, leftOffset + width, topOffset + this.offsetY + height);
