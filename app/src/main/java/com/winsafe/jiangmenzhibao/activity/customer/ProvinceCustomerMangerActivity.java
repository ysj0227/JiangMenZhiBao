...
public class ProvinceCustomerMangerActivity extends AppBaseActivity {
    ...
    protected void initView() {
        setHeader("市经销商管理", true, true, 0, "新增", this);
        ...
        lvListData.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                openActivity(ProvinceCustomerMangerActivity.this, ProvinceCustomerDetailsActivity.class, bundle, false);
            }
        });
    ...
    private void getList(final String key) {
        ...
        OkHttpUtils.post().url(AppConfig.URL_APPLOADCOMPANY).addParams("encode", encode).build()
                .execute(new StringCallback() {
                    @Override
                    public void onError(Call call, Exception e) {
                        stopDialogProgress();
                        Toast.makeText(ProvinceCustomerMangerActivity.this, getResources().getString(R.string.network_wifi_low), Toast.LENGTH_SHORT).show();
                    ...
                    public void onResponse(Call call, String s) {
                        ...
                        if ("0".equals(bean.getReturnCode())) {
                            ...
                            //信息筛选
                            CustomerBean.ReturnDataBean.CompanyinfoBean info = null;
                            ...
                            lvListData.setAdapter(new CustomerAdpter(ProvinceCustomerMangerActivity.this, listKey));
                        }else if("-2".equals(bean.getReturnCode())){
                            Toast.makeText(ProvinceCustomerMangerActivity.this, bean.getReturnMsg(), Toast.LENGTH_SHORT).show();
                            openActivity(ProvinceCustomerMangerActivity.this, LoginActivity.class,true);
                        } else {
                            Toast.makeText(ProvinceCustomerMangerActivity.this, bean.getReturnMsg(), Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnOther://省级新增客商
                Bundle bundle = new Bundle();
                bundle.putString(AppConfig.CUSTOMER_NAME, AppConfig.ADD);
                bundle.putString(AppConfig.ENCODE, encode);
                openActivity(ProvinceCustomerMangerActivity.this, ProvinceAddCustomerActivity.class, bundle, false);
                break;
