...
public class CountyCustomerDetailsActivity extends AppBaseActivity {
    ...
    protected void initView() {
        setHeader("零售商信息", true, false, 0, "", null);
        ...
        btnSetOrgan.setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        switch(v.getId()){
           case R.id.btnFix ://编辑
               ...
               openActivity(CountyCustomerDetailsActivity.this, CountyAddCustomerActivity.class,mBundle,true);
        ...
        OkHttpUtils.post().url(AppConfig.URL_APPDELETECOMPANY).addParams("encode", Encode).build()
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e) {
                        stopDialogProgress();
                        Toast.makeText(CountyCustomerDetailsActivity.this, getResources().getString(R.string.network_wifi_low), Toast.LENGTH_SHORT).show();
                    ...
                    public void onResponse(Call call, String s) {
                        ...
                        try {
                            ...
                            if ("0".equals(code)){
                                Toast.makeText(CountyCustomerDetailsActivity.this, msg, Toast.LENGTH_SHORT).show();
                                CountyCustomerDetailsActivity.this.finish();
                            }else if("-2".equals(code)){
                                Toast.makeText(CountyCustomerDetailsActivity.this, msg, Toast.LENGTH_SHORT).show();
                                openActivity(CountyCustomerDetailsActivity.this, LoginActivity.class,true);
                            } else {
                                Toast.makeText(CountyCustomerDetailsActivity.this, msg, Toast.LENGTH_SHORT).show();
