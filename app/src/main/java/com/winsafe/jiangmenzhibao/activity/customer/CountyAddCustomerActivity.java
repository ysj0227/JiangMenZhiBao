...
public class CountyAddCustomerActivity extends AppBaseActivity implements OnWheelChangedListener {
    ...
    protected void initView() {
        ...
        if (AppConfig.ADD.equals(mType)) {//当省级账号和县级账号登录时newEncode=LoginActivity.encode;
            title = GlobalHelper.showString(this, R.string.title_addcounty_customer);
            ...
            title = GlobalHelper.showString(this, R.string.title_editcounty_customer_msg);
        ...
        OkHttpUtils.post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e) {
                        stopDialogProgress();
                        Toast.makeText(CountyAddCustomerActivity.this, getResources().getString(R.string.network_wifi_low), Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onResponse(Call call, String s) {
                        ...
                        try {
                            ...
                            if ("0".equals(code)) {
                                Toast.makeText(CountyAddCustomerActivity.this, msg, Toast.LENGTH_SHORT).show();
                                CountyAddCustomerActivity.this.finish();
                            } else if("-2".equals(code)){
                                Toast.makeText(CountyAddCustomerActivity.this, msg, Toast.LENGTH_SHORT).show();
                                openActivity(CountyAddCustomerActivity.this, LoginActivity.class,true);
                            } else {
                                Toast.makeText(CountyAddCustomerActivity.this, msg, Toast.LENGTH_SHORT).show();
    ...
    private void setUpData() {
        initProvinceDatas();
        mViewProvince.setViewAdapter(new ArrayWheelAdapter<String>(CountyAddCustomerActivity.this, mProvinceDatas));
        // 设置可见条目数量
