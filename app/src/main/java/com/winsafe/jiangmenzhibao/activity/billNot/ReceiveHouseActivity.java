...
public class ReceiveHouseActivity extends AppBaseActivity {
    ...
    protected void initView() {
        setHeader("选择收货仓库", true, false, 0, "", null);
        mBundle=getIntent().getExtras();
        ToOrganID=mBundle.getString("ToOrganID");
        getList();
    ...
    private void getList() {
        list= MyApp.warehouseDB.findAllByWhere(WarehouseDataBean.class,
                " type=\"" +AppConfig.AUTHORITY_RECEIVE+ "\""+" and "+" organID=\"" + ToOrganID+ "\"");
        mList=list;
        lvListData.setAdapter(new HouseAdpter(ReceiveHouseActivity.this,mList));
