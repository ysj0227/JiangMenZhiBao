...
/**
 * 出库管理
 * Created by shijie.yang on 2017/5/20.
 */

public class BillOutActivity extends AppBaseActivity {
    ...
    protected void initView() {
        setHeader("出库管理", true, false, 0, "", null);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ivBill://选择出库单据
                Bundle bundles=new Bundle();
                bundles.putString("BillSort","1");
                openActivityForResult(BillOutActivity.this, BillDataListActivity.class, RETURN_DATA_SEND_ORGAN,bundles);
            ...
            case R.id.btnScan://出库扫描
                ...
                openActivity(BillOutActivity.this, CaptureActivity.class, bundle, false);
                break;
