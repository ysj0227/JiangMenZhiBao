...
public class ProvinceAddCustomerActivity extends AppBaseActivity implements OnWheelChangedListener {
    ...
    ImageView ivArea;
    @BindView(R.id.tvDetailsAdds)//详细地址
            EditText tvDetailsAdds;
    @BindView(R.id.tvName)//机构名称
            EditText tvName;
    @BindView(R.id.tvNumber)//外部编号
            EditText tvNumber;
    @BindView(R.id.tvPhone)//手机
            EditText tvPhone;
    ...
    private String CompantFullName = "", Telnum = "", Encode = "", Provincename = "",
            Cityname = "", Countyname = "", Registedaddress = "";
    ...
    protected void initView() {
        ...
        String title = "";
        if (AppConfig.ADD.equals(mType)) {//当省级账号和县级账号登录时newEncode=LoginActivity.encode;
            title = GlobalHelper.showString(this, R.string.title_add_customer);
            ...
            title = GlobalHelper.showString(this, R.string.title_edit_customer_msg);
    ...
    private void addCustomers() {
        ...
        int comtype= Integer.valueOf(LoginActivity.companyType)+1;
        Map<String, String> map = new HashMap<>();
        map.put("companytype", String.valueOf(comtype));//省账号类型
...
//        Log.i("TAG", LoginActivity.companyType+"===省");
        OkHttpUtils.post()
                .url(Url)
                .params(map)
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e) {
                        stopDialogProgress();
                        Toast.makeText(ProvinceAddCustomerActivity.this, getResources().getString(R.string.network_wifi_low), Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onResponse(Call call, String s) {
                        ...
                        try {
                            ...
                            if ("0".equals(code)) {
                                Toast.makeText(ProvinceAddCustomerActivity.this, msg, Toast.LENGTH_SHORT).show();
                                ProvinceAddCustomerActivity.this.finish();
                            }else if("-2".equals(code)){
                                Toast.makeText(ProvinceAddCustomerActivity.this, msg, Toast.LENGTH_SHORT).show();
                                openActivity(ProvinceAddCustomerActivity.this, LoginActivity.class,true);
                            }  else {
                                Toast.makeText(ProvinceAddCustomerActivity.this, msg, Toast.LENGTH_SHORT).show();
                            }
    ...
    private void setUpData() {
        initProvinceDatas();
        mViewProvince.setViewAdapter(new ArrayWheelAdapter<String>(ProvinceAddCustomerActivity.this, mProvinceDatas));
        // 设置可见条目数量
